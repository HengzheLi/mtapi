...
{
    //internal class MtServerStandard : IDisposable, IMtApiServer
    //{
    //    #region Constants
    ...
    //    #region Fields
    //    private static readonly ILog Log = LogManager.GetLogger(typeof(MtServerStandard));

    //    private readonly MtServiceStandard _service;
    ...
    //    #region ctor
    //    public MtServerStandard(int port)
    //    {
    //        Port = port;
    //        _service = new MtServiceStandard(this);
    //    }
    //    #endregion
