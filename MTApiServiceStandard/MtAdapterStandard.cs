...
namespace MTApiService
{
    public class MtAdapter
    {
        ...
        //private readonly Dictionary<int, MtServerStandard> _servers = new Dictionary<int, MtServerStandard>();
        ...
        public void AddExpert(int port, MtExpert expert)
        {
            ...
            //    else
            //    {
            //        server = new MtServerStandard(port);
        ...
        {
            //var server = (MtServerStandard)sender;
            //server.Stopped -= server_Stopped;
