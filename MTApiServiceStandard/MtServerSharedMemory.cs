...
namespace MTApiServiceStandard
{
    internal class MtServerSharedMemory : IDisposable, IMtApiServer
    {
        #region Constants
        ...
        private readonly List<ServiceHostSharedMemory> _hosts = new List<ServiceHostSharedMemory>();
        ...
        #region ctor
        public MtServerSharedMemory(int port)
        {
            Port = port;
