...
namespace MTApiService
{
    ...
    public sealed class MtServiceStandard : IMtApi
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(MtServiceStandard));

        public MtServiceStandard(IMtApiServer serverCallback)
        {
